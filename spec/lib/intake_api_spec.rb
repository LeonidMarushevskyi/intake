...
describe IntakeAPI do
  before do
    allow(described_class).to receive(:connection)
      .and_return(Faraday.new(url: 'http://api_url'))
  end

  describe '.make_api_call' do
    let(:security_token) { FFaker::Guid.guid }

    it 'sends get requests to the Intake API' do
    ...
    it 'sends post requests to the Intake API' do
    ...
    it 'sends put requests to the Intake API' do
    ...
    it 'sends delete requests to the Intake API' do
