...
describe('ScreeningInformationShowView', () => {
  ...
  it('renders the screening show fields', () => {
    ...
    expect(component.find('ShowField[label="Assigned Social Worker"]').props().labelClassName)
      .toEqual('required')
    expect(component.find('ShowField[label="Screening Start Date/Time"]').props().labelClassName)
      .toEqual('required')
    expect(component.find('ShowField[label="Communication Method"]').props().labelClassName)
      .toEqual('required')
