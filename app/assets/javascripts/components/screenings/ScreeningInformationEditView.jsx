...
const ScreeningInformationEditView = ({screening, onCancel, onChange, onSave, validate, errors}) => {
  const validateOnChange = (fieldName, value) => {
    if (errors.get(fieldName) && !errors.get(fieldName).isEmpty()) {
      ...
      <div className='card-body'>
        <div className='row'>
          ...
          <InputField
            ...
            onBlur={(event) => validate('assignee', event.target.value)}
        ...
        <div className='row'>
          <DateField
            ...
            onBlur={(value) => validate('started_at', value)}
          ...
          <DateField
            ...
            onBlur={(value) => validate('ended_at', value)}
        ...
        <div className='row'>
          <SelectField
            ...
            onBlur={(event) => validate('communication_method', event.target.value)}
