export const CLEAR_CROSS_REPORT_AGENCY_FIELD_VALUES = 'CLEAR_CROSS_REPORT_AGENCY_FIELD_VALUES'
export const CLEAR_CROSS_REPORT_FIELD_VALUES = 'CLEAR_CROSS_REPORT_FIELD_VALUES'
...
export function clearAllFields() {
  return {type: CLEAR_CROSS_REPORT_FIELD_VALUES}
}
export function clearAllAgencyFields(agencyType) {
  return {type: CLEAR_CROSS_REPORT_AGENCY_FIELD_VALUES, agencyType}
}
