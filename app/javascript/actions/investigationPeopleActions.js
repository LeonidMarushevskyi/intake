...
export const FETCH_INVESTIGATION_PEOPLE_SUCCESS = 'FETCH_INVESTIGATION_SUCCESS'
export const FETCH_INVESTIGATION_PEOPLE_FAILURE = 'FETCH_INVESTIGATION_FAILURE'
